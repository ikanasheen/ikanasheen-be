...
public interface NelayanTransform {
    ...
    @Mapping(target = "kecamatanId", source = "requestDto.kecamatanId")
    ...
    @Mapping(target = "kecamatanId", expression = "java(nelayan.getKecamatanId() == null || nelayan.getKecamatanId().isEmpty() ? nelayanRepo.getKecamatanId() : nelayan.getKecamatanId())")
